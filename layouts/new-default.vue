<template>
  <v-app>
    <v-navigation-drawer
      app
      class="desktop"
      style="background: linear-gradient(180deg, #f7931d 50%, #fec34f 94.32%)"
    >
      <img src="~/assets/svg/wave-menu.svg" class="absolute w-full bottom-0" />
      <div class="h-full">
        <div class="logo_container my-8">
          <img src="~/assets/icon/bpos-white.png" alt="logo" class="mx-auto" />
        </div>
        <v-list class="bg-transparent">
          <v-list-item router to="/transaction/submission" class="text-white">
            <v-list-item-action>
              <refresh-cw-icon
                size="1.5x"
                class="custom-class"
    ...
    <v-bottom-navigation fixed color="#F15921" grow class="mobile">
      <v-btn
    ...
    <v-app-bar app class="flex justify-end">
      <span class="mr-6">
      ...
      <span>
        <div class="small-profile">
          <div class="sec-title">
            <p class="_policy">
              {{
                myPolicy ? myPolicy.policyWithCode.proposalNumber : "Memuat..."
              }}
            </p>
            <p class="_name">
              {{
