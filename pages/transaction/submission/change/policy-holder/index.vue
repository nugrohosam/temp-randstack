      ...
      <form @submit.prevent="save">
        ...
        <div class="row">
          <div class="col-lg-4 col-sm-6">
            ...
            <small
              >Tempat Lahir tidak bisa menggunakan huruf dan tanda baca</small
            >
          </div>
          <div class="col-lg-4 col-sm-6">
            <p class="data-title mb-2">Alamat Email</p>
          ...
          <div class="col-lg-12 col-sm-12">
            <div class="message-bar rounded-lg">
              ...
              <ul>
                ...
                <li>
                  - Jika Pemegang polis dan Tertanggung sama, mohon merubah
                  jenis kelamin dan Tanggal lahir melalui menu Perubahan Data
                  tgl lahir & Jenis Kelamin tertanggung.
                </li>
              </ul>
            </div>
          </div>
  ...
  methods: {
    ...
    validate() {
      ...
      if (!this.form.ktpSelfieAttachment.name) {
        this.validationMessage.push(
          "Unggah Selfie + KTP Pemegang Polis diperlukan"
        );
      }
    },
